...
<body>
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo" style="background:teal;">
        <div class="wrapper wrapper--w680" style="border-top:10px solid red;">
            <div class="card card-1">
                <div class="card-heading"></div>
                <div class="card-body">
                    <h2 class="title" style="text-align:center;font-family: 'Lobster', cursive;color:teal;">Update Employee Info <span style="color:teal;font-family: 'Lobster', cursive;">Info</span></span></h2>
