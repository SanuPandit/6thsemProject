   ...
   <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo" style="background:#5D6D7E;">
        <div class="wrapper wrapper--w680" style="border-top:10px solid red;">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title" style="text-align:center;font-family: 'Lobster', cursive;color:teal;">Assign  <span style="color:teal;font-family: 'Lobster', cursive;">Project</span></span></h2>
                    <!-- for testing -->
